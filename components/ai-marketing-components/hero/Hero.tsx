      ...
      <div className="hero-style hero-style--three sec-border pos-rel">
        <div className="container-fluid">
          <div className="hero-content hero-content--three">
            ...
            <div className="xb-content-holder wow fadeInUp" data-wow-duration="600ms">
              <h2 className="title">
                Uniting Industries.{" "}
                <Image src={gif1} alt="animated gif" unoptimized />Empowering Connections Through Our Events.
              </h2>
        ...
        <div className="background_video">
          <video
            ...
            src="https://gdcc-expo.com/wp-content/uploads/2026/05/13820343_3840_2160_30fps.mp4" 
            loop
            muted
            playsInline
            autoPlay
