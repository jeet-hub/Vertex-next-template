...
import indusLogo from "@/public/images/industries/vertex.png";
    ...
    <section className="industries pos-rel pt-145 pb-50 bg_img">
      <div className="container">
        <div className="sec-title sec-title-center text-center mb-40">
          <span className="sub-title mb-15">Global Footprint</span>
          <h2 className="title">Everywhere Business Gets Done.</h2>
          <p>Vertex Next convenes the world's most significant buyers and sellers of digital infrastructure and energy technology — drawing participants from the Americas, Europe, the Middle East, Asia Pacific and West Africa into structured, high-value commercial environments built for one purpose: deal flow.</p>
        </div>
