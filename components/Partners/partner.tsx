        ...
        <div className="ai-about-wrap mlr-20">
          <div className="ai-about-inner">
            ...
            <div className="sec-title-three">
              <span className="sub-title">Global Sponsors & Partners</span>
              <h2 className="title xb-text-reveal">
                The World's Most Consequential <br/>Brands Choose Vertex Next
              </h2>
            </div>
            ...
            <div className="ai-about-bottom ul_li">
              <p>
                Our global partner ecosystem encompasses technology OEMs, multilateral development institutions, trade associations, government bodies and media intelligence organisations — collectively representing the full institutional architecture of digital and energy infrastructure investment, worldwide.
               </p>
