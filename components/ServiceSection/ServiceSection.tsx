...
// Service images
import img01 from "@/public/images/service/section-1.png";
import img02 from "@/public/images/service/section-2.png";
import img03 from "@/public/images/service/section-3.png";
import img04 from "@/public/images/service/sleas.png";
import img05 from "@/public/images/service/digi.png";
import img06 from "@/public/images/service/ghcc.png";

// Event logo images
import logo01 from "@/public/images/icon/iot-p.svg";
import logo02 from "@/public/images/icon/Pnw.svg";
import logo03 from "@/public/images/icon/gdcc.svg";
import logo04 from "@/public/images/icon/slea.png";
import logo05 from "@/public/images/icon/digi.png";
import logo06 from "@/public/images/icon/ghcc.svg";
...
const services: ServiceItem[] = [
  {
    ...
    desc: "West Africa’s leading IoT, Cybersecurity, and Digital Transformation exhibition connecting global technology leaders, enterprises, and government stakeholders.",
    img: img01,
    icon: logo01,
  ...
  },
  {
    id: 2,
    title: "PnW Nigeria",
    desc: "Nigeria’s premier energy event uniting global power, renewable, and infrastructure leaders across generation, transmission, and new energy solutions.",
    img: img02,
    icon: logo02,
  ...
  },
  {
    id: 3,
    title: "Gdcc Expo",
    desc: "The Global Data Centre & Cloud Expo connects hyperscalers, cloud providers, and infrastructure leaders shaping the future of digital infrastructure worldwide.",
    img: img03,
    icon: logo03,
              ...
              <div className="xb-item--item">
                <div className="xb-item--head-item">
                  <h3 className="xb-item--title border-effect">
                     <Image src={service.icon} alt={service.title} /><br/>
