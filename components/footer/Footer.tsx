...
---------------------------------------- */
const socials = [
  { icon: <FacebookIcon />, name: "Facebook", url: "https://www.facebook.com/VertexNext?mibextid=LQQJ4d" },
  { icon: <TwitterIcon />, name: "Twitter", url: "https://twitter.com/vertexnext" },
  { icon: <LinkedinIcon />, name: "LinkedIn", url: "https://www.linkedin.com/company/vertex-next" },
  { icon: <YoutubeIcon />, name: "Instagram", url: "https://www.instagram.com/vertex_next/" },
];
    ...
    >
      <div className="xb-footer-wrap">
        ...
        <div className="xb-footer-heading wow zoomIn" data-wow-duration="600ms">
          <h1 className="title">Vertex</h1>

          <a className="mail" href="mailto:info@vertexnext.com">
        ...
        <div className="xb-footer-nav">
          {[
            { label: "Our Upcoming ", title: "Events", href: "/service" },
        ...
        <div className="xb-footer-bottom">
          <div className="contact-item">
            ...
            <span className="contact-method">Dubai Branch Building, 1-141, Mankhool, Dubai, UAE</span>
          </div>

          <div className="contact-item copyright-item">
            <p>
              Copyright © 2026{" "}
              <Link href="/">Vertex next</Link>, All rights reserved.
            </p>
          </div>
