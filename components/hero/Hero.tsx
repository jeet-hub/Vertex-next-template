          ...
          <div className="col-lg-9 col-md-9">
            <div className="hero-content">
              <h2 className="title scale-animation wow">
                Uniting Industries. Empowering Connections.
              </h2>

              <p className="sub-title scale-animation wow">
                Vertex Next builds world-class B2B exhibition and conference platforms for the digital infrastructure industry.
                We connect visionaries, decision-makers, and global opportunities that drive impactful business growth.
              </p>
          ...
          <div className="col-lg-4 col-md-6 mt-30">
            <div className="xb-feature-item wow fadeInUp" data-wow-delay="900ms">
              <div className="xb-item--inner xb-border">
                ...
                <p className="xb-item--content">
                  We deliver end-to-end event intelligence that drives impactful business connections and measurable<br></br> outcomes across global markets.
                </p>
              </div>
            </div>
          </div>
